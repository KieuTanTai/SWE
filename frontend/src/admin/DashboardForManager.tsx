    ...
    <div className="py-4 px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
        {stats.map((item: Stat, index: number) => (
          <div key={index} className="bg-white rounded-lg shadow flex flex-col items-center p-4">
            {item.icon}
      ...
      <div className="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 shadow flex items-center mb-4">
        ...
        Tuyến đường Maple Express sẽ thay đổi lịch trình trong tuần này do nâng cấp đường.
      </div>
