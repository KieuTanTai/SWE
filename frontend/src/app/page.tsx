...
import { Parent, Person } from "@/interfaces";
                  ...
                  return (
                    <tr key={student.student_id} className={`hover:bg-gray-750 transition-colors group ${!isActive ? 'opacity-50 bg-gray-900' : ''}`}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-400">
                        ...
                        {(student.parent as Parent)?.person?.person_name || `ID: ${student.student_parent_id}`}
                      </td>
                          ...
                          {isActive ? (
                            <>
                             ...
                             <ScanEye size={18} /> View 
                              ...
                              <button 
                                onClick={() => student.student_id && studentService.deleteStudent(student.student_id)}
