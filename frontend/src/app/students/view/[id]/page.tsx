  ...
  useEffect(() => {
    const fetchStudent = async () => {
      try {
        ...
        setStudentData({
          person_name: data.person?.person_full_name || "N/A",
          person_gender: data.person?.person_gender || "N/A",
          person_birthday: data.person?.person_birthday || "N/A",
          person_email: data.person?.person_email || "N/A",
