-- Tạo schema SSB và sử dụng schema đó
...
-- Triggers kiểm tra nhất quán enum
DELIMITER //

CREATE TRIGGER trg_check_parent_person_type
...
CREATE TRIGGER trg_check_driver_person_type
...
CREATE TRIGGER trg_check_schedule_manager_type
